...
function getInfoBasedOnScore(){
    if(totalScore() <7){
        var score_info= "Você ainda precisa praticar um pouco mais!";
    } else if (totalScore() > 7){
        var score_info = "PARABÉNS, você está no caminho para desenvolver uma nova habilidade! Baixe agora o seu Certificado."
